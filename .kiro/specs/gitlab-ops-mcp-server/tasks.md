...
- [x] 2. Webhook tool handlers
  ...
  - [x]* 2.2 Write unit tests for webhook handlers
...
- [x] 3. CI/CD variable tool handlers
  ...
  - [x]* 3.2 Write unit tests for CI variable handlers
    - Test each handler with mock API client
...
- [x] 4. Protected branch and project settings tool handlers
  ...
  - [x]* 4.3 Write unit tests for protected branch and project settings handlers
...
- [x] 6. Group, access token, and pipeline trigger tool handlers
  ...
  - [x]* 6.4 Write unit tests for group, access token, and pipeline trigger handlers
...
- [x] 7. Server entry point and tool registration
  ...
  - [x]* 7.3 Write unit tests for server initialisation
...
- [x] 8. Property-based tests
  - [x]* 8.1 Write property test for tool-to-API request mapping
  ...
  - [x]* 8.2 Write property test for authentication header inclusion
  ...
  - [x]* 8.3 Write property test for required parameter validation
  ...
  - [x]* 8.4 Write property test for enum parameter validation
  ...
  - [x]* 8.5 Write property test for HTTP error propagation
